...
+ **Inversion of Control and Dependency Injection**
	...
	In brief, dependency injection should be used to allow to override the behaviour of some components, and this is usefull when you want to do tests (but even without test, allow more modularity is always a good thing)
